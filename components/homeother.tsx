                    ...
                    <div className={Styles.cardContainer}>
                        ...
                        <div className={Styles.smallCard}>
                            <div className={Styles.smallCardItem}>
                                <Image width={150} height={200} src="/boat.jpg" alt="" loading='lazy' />
                                <p>Up to 75% off | boAt</p>
                            </div>
                            <div className={Styles.smallCardItem}>
                                <Image width={150} height={200} src="/boult.jpg" alt="" loading='lazy' />
                                <p>Up to 75% off | boult</p>
                            </div>
                            <div className={Styles.smallCardItem}>
                                <Image width={150} height={200} src="/noise.jpg" alt="" loading='lazy' />
                                <p>Up to 75% off | noise</p>
                            </div>
                            <div className={Styles.smallCardItem}>
                                <Image width={150} height={200} src="/zebronics.jpg" alt="" loading='lazy' />
